<template>
    ...
    <div>
        <Section class="bg-gray-800 pt-16 h-screen">
            <div class="h-2/3 flex flex-wrap content-between pb-36">
                <p class="border-b-2 font-bold border-gray-400 pb-3 text-4xl text-gray-300 uppercase">
                    Hey! This is Márlon. I'm a Senior Software Engineer, and I would be
                ...
                <div class="flex items-end border-b-2 border-gray-500 pb-2">
                    ...
                    <jet-button class="bg-green-400 rounded font-bold text-sm text-gray-800 hover:bg-green-800"
        ...
        <Section class="bg-gray-600 text-gray-200 h-screen">
            ...
            <div class="flex justify-center mt-10">
                <jet-button class="bg-purple-100 rounded font-bold text-sm text-gray-800 hover:bg-purple-200"
                    @click="contacting = true">
                    Know more
                </jet-button>
            </div>
        ...
        <Section class="flex justify-between bg-gray-800 text-gray-300 text-xl">
            <p>&copy; Eagle Sistemas. All right reserved.</p>
    ...
    <jet-modal :show="contacting" closable="true" @close="contacting = false">
